...
mix.babel('node_modules/izitoast/dist/js/iziToast.min.js',
 ...
 mix.js('resources/assets/js/account_types/account_types.js', 'public/assets/js/account_types/account_types.js').version();


 mix.js('resources/assets/js/account_managers/account_managers.js', 'public/assets/js/account_managers/account_managers.js').version();


 mix.js('resources/assets/js/blacklisted_clients/blacklisted_clients.js', 'public/assets/js/blacklisted_clients/blacklisted_clients.js').version();


 mix.js('resources/assets/js/client_accounts/client_accounts.js', 'public/assets/js/client_accounts/client_accounts.js').version();
